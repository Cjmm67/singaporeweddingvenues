...
const VENUE_FAQS={"the-garage":[{q:"Is my preferred wedding date available at il Giardino?",a:"We'd love to check for you! Popular dates, especially weekends, tend to fill up quickly, so we recommend reaching out early. Our friendly team can check availability and even hold a tentative date while you finalise your plans."},{q:"What is the minimum spending or minimum number of guests required?",a:"Our packages are flexible — whether you're planning an intimate solemnisation or a full celebration of up to 145 guests. There's a minimum spend which our wedding specialists will share based on your preferred date and time."},{q:"What is the maximum capacity at il Giardino?",a:"Depending on your celebration style, we can accommodate: Banquet-style — up to 145 guests (86 indoors, 59 outdoors); Cocktail reception — up to 200 guests. We can also host your solemnisation, lunch, and dinner all in one beautiful location."},{q:"What does your wedding package include?",a:"Our wedding packages typically include: a customised Western 4-course menu lovingly crafted by our chefs; beer, wines by the bottle, and free-flow soft drinks, juices, coffee, and tea; use of our sound system, projector, and microphones; a cosy bridal changing room; customised printed menus and place cards for each guest; professional service staff; and fresh floral décor from our partner florists. We're happy to tailor the package to your preferences."},{q:"Can we bring in our own vendors (florists, photographers, decorators)?",a:"Of course! You're welcome to work with your preferred vendors. We also have a list of trusted partners who know our venue well if you'd like some recommendations."},{q:"Do you have wet-weather backup options?",a:"Yes, we do. We completely understand that Singapore's weather can be unpredictable! Our outdoor terrace is fully sheltered, so you and your guests can celebrate comfortably, rain or shine."},{q:"What are the payment, deposit, postponement, and cancellation policies?",a:"A deposit is required to secure your date, with the remaining balance due on your wedding day. If you need to postpone, our team will gladly help you find a new date. All cancellation terms are clearly outlined in your contract for full transparency."},{q:"Do you cater to special dietary requirements (vegetarian, vegan, halal, etc.)?",a:"Absolutely! Our chefs can prepare vegetarian, vegan, gluten-free, and other special meals with advance notice. While our kitchen isn't halal-certified, we can arrange halal meals through trusted partners upon request."},{q:"Can we have a food tasting before confirming?",a:"Yes! Menu tastings are available for confirmed wedding packages, so you can experience our dishes before making your final selections."},{q:"How long is the venue booking for?",a:"Our standard package includes 4 hours of event time for lunch, and 4.5 hours for dinner."},{q:"What facilities and amenities are provided?",a:"We provide: a bridal changing room; sound system, projector, and screen; on-site event operations team and wedding coordinator support; nearby parking; and a convenient location with direct MRT access (Botanic Gardens MRT)."},{q:"Are there any décor restrictions?",a:"We love seeing creative décor ideas! You're welcome to decorate the space as long as nothing damages the venue. For items like candles or hanging décor, just check with us beforehand so we can advise on safety guidelines."},{q:"Do you offer packages for weekday or lunch weddings?",a:"Yes, we do! Weekday and lunch weddings are a wonderful choice for couples looking for a more intimate setting or great value. Ask us about our latest promotions."},{q:"Is there a cutoff time for music and celebrations?",a:"Our standard end times are 2:00 PM for lunch and 10:30 PM for dinner."},{q:"Will I have a dedicated wedding coordinator?",a:"Yes! Once your booking is confirmed, a dedicated wedding specialist will be assigned to you about two months before your big day. They'll guide you through every step and ensure everything runs seamlessly."},{q:"How far in advance should we book?",a:"Most couples secure their date anywhere from 6 to 18 months in advance, especially for popular weekend slots. But if you're planning a shorter timeline, don't worry — we'll do our best to accommodate you."},{q:"What if my guest numbers change?",a:"We completely understand that RSVPs can fluctuate. Our team will advise you on the minimum guaranteed number and help make any necessary adjustments closer to your wedding day."},{q:"Is parking available for guests?",a:"Yes, parking is available at Cluny Park Gate Carpark, and we're just steps away from Botanic Gardens MRT station for added convenience."},{q:"Do you offer accommodation packages for out-of-town guests?",a:"While we don't provide accommodation directly, we partner with nearby hotels such as St. Regis Hotel, Fullerton Hotel, and Fullerton Bay Hotel, and can extend our corporate rates for your guests."},{q:"Are pets allowed at the venue?",a:"Yes, they are! Our outdoor terrace is pet-friendly, and we're delighted to welcome your furry friends. We allow up to two small to medium-sized pets per wedding celebration."},{q:"How do I arrange a site visit?",a:"We'd love to show you around! Simply contact our wedding team at enquiry@thegarage.sg or fill out the enquiry form on our website. We'll be delighted to host you for a private tour of our beautiful wedding space."}]};

function FAQAccordion({faqs,venueName}){const[open,setOpen]=useState({});const toggle=i=>setOpen(p=>({...p,[i]:!p[i]}));return<div itemScope itemType="https://schema.org/FAQPage" style={{marginBottom:22}}>{faqs.map((faq,i)=><div key={i} itemProp="mainEntity" itemScope itemType="https://schema.org/Question" style={{borderBottom:"1px solid var(--gpa)"}}><button onClick={()=>toggle(i)} style={{width:"100%",display:"flex",justifyContent:"space-between",alignItems:"center",padding:"14px 0",background:"none",border:"none",cursor:"pointer",textAlign:"left",gap:12}}><h4 itemProp="name" style={{fontWeight:600,fontSize:13,color:"var(--cd)",flex:1,lineHeight:1.5}}>{faq.q}</h4><span style={{flexShrink:0,width:24,height:24,borderRadius:"50%",background:open[i]?"var(--sa)":"var(--gg)",display:"flex",alignItems:"center",justifyContent:"center",transition:"all .25s ease",color:open[i]?"var(--w)":"var(--g)",fontSize:16,fontWeight:300,transform:open[i]?"rotate(45deg)":"rotate(0deg)"}}>+</span></button><div itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer" style={{maxHeight:open[i]?500:0,overflow:"hidden",transition:"max-height .3s ease"}}><p itemProp="text" style={{fontSize:13,color:"var(--cl)",lineHeight:1.8,paddingBottom:14}}>{faq.a}</p></div></div>)}</div>}
